...
export interface PairBooleanString {
  right?: string;
  value?: string;
  key?: boolean;
  left?: boolean;
...
export interface RestResponsePairBooleanString {
  metaData?: {
    [key: string]: { [key: string]: any };
  };
  resource?: PairBooleanString;
  responseMessages?: ResponseMessage[];
}
...
export type UpdateGcpSecretsManagerConfig1RequestBody = void;
...
export interface GetAuthenticationInfoQueryParams {
  accountId?: string;
}

export type GetAuthenticationInfoProps = Omit<
  GetProps<
    RestResponseAuthenticationInfo,
    unknown,
...
export const GetAuthenticationInfo = (props: GetAuthenticationInfoProps) => (
  <Get<
    RestResponseAuthenticationInfo,
    unknown,
    GetAuthenticationInfoQueryParams,
...
export type UseGetAuthenticationInfoProps = Omit<
  UseGetProps<
    RestResponseAuthenticationInfo,
    unknown,
    GetAuthenticationInfoQueryParams,
...
export const useGetAuthenticationInfo = (
  props: UseGetAuthenticationInfoProps
) =>
  useGet<
    RestResponseAuthenticationInfo,
    unknown,
    GetAuthenticationInfoQueryParams,
    void
  >(`/account/authentication-info`, { base: getConfig("api"), ...props });
