var SecureStorage = /******/ (function (modules) {
  // webpackBootstrap
  /******/ // The module cache
  ...
  /******/ [
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var SecureStorage = Generator.generate(function SecureStorage(
        storage,
        options
      ) {
        var _ = this;
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      (function GeneratorScope() {
        ...
        function assertTypeError(test, type) {
          if (typeof test !== type) {
            throw new TypeError(
              "Expected '" + type + "' but instead found '" + typeof test + "'"
            );
          }
        }
        ...
        function isGetSet(obj) {
          ...
          if (obj && typeof obj === "object") {
            ...
            if (
              (length === 1 &&
                ((keys[0] === "get" && typeof obj.get === "function") ||
